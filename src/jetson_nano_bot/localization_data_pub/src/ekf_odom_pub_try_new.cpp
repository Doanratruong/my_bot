...
void update_odom() 
{
    ...
    odom_msg.pose.pose.angular.z = cycleAngle/(odom_msg.header.stamp.toSec() - odomOld.header.stamp.toSec())
    odom_msg.pose.pose.orientation.z = cycleAngle + odomOld.pose.pose.orientation.z;
